...
public class TransactionsListMock {
	...
	public static void addSampleDataset() {
		...
		addSampleTransaction("100004", "100", "restaurant emile", 43.597332f,
				1.44556f);
		addSampleTransaction("100005", "22", "restaurant le 19", 43.597495f,
				1.445569f);
		addSampleTransaction("100006", "45", "restaurant Michel Sarran",
				43.597328f, 1.445153f);
		addSampleTransaction("100007", "76", "resto Jazz", 43.597361f, 1.44585f);
		addSampleTransaction("100008", "33", "resto abder", 43.597306f,
				1.444989f);
		addSampleTransaction("100009", "12", "bistro saint georges",
				43.601885f, 1.447513f);
		addSampleTransaction("100010", "9", "le bistro d'eric", 43.601574f,
				1.447706f);
		addSampleTransaction("100011", "12", "bistro campel", 43.60204f,
				1.451848f);
		addSampleTransaction("100012", "7", "le bistro de julie", 43.601434f,
				1.451933f);
		addSampleTransaction("100013", "8", "bistro de lille", 43.602351f,
				1.456461f);
		addSampleTransaction("100014", "9", "le chevillard", 43.608737f,
				1.450346f);
		addSampleTransaction("100015", "56", "eros & agap", 43.613242f,
				1.444595f);
		...
		addSampleTransaction("100019", "89", "grenier d'anais", 43.604138f,
				1.444831f);
		addSampleTransaction("100020", "32", "ethic et chix", 43.604542f,
				1.44556f);
		addSampleTransaction("100021", "32", "carte blanche", 43.603609f,
				1.444187f);
		addSampleTransaction("100022", "4", "corleone", 43.604674f, 1.44291f);
		addSampleTransaction("100023", "24", "zara ", 43.604969f, 1.443619f);
